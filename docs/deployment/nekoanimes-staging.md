...
```text
android/v1.0.2/NekoAnimes-v1.0.2.apk
android/v1.0.2/NekoAnimes-v1.0.2.apk.sha256
```

O workflow guarda o APK como artifact e cria a prerelease GitHub
`v1.0.2-staging`; não é release de produção. A URL pública atual do APK é:

<https://pub-d7e4841d19c54db9bbeedcdc3af062c1.r2.dev/android/v1.0.2/NekoAnimes-v1.0.2.apk>
