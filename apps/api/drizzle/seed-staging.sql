...
VALUES (1, 1, 'streaming', '{"ads":{"enabled":false,"engine":"max","banner":{"enabled":false},"appOpen":{"enabled":false,"minIntervalMinutes":60,"skipFirstOpens":3},"interstitial":{"enabled":false,"minIntervalMinutes":30,"maxPerSession":2,"pageTransitionFrequency":3,"showOnEpisodeStart":true}}}')
