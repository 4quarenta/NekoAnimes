...
export type SaveProviderAnimeDataResponse = { ok: true; saved: true; anime: { id: string; slug: string; title: string; imageUrl: string | null; backdropUrl: string | null }; sources: { myanimelist: boolean; anilist: boolean; anidb: boolean }; savedAt: string };
export function saveProviderAnimeData(serverId: string, reference: string) { return authJson<SaveProviderAnimeDataResponse>('/v1/catalog/provider-data', { method: 'POST', body: JSON.stringify({ serverId, reference }) }); }
