...
function isNativeRoute(route: string): route is NativeRoute {
  return (NATIVE_ROUTES as readonly string[]).includes(route);
}
...
export function App() {
  useEffect(() => {
    ...
    const onResolved = () => {
      ...
      if (isNativeRoute(route)) NekoNative.routeChanged(route);
    };
