/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: 8e8e20dcbadaabba0ab0054e88d5fa73)
// Runtime types generated with workerd@1.20260915.1 2026-09-11 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	BROWSER: BrowserRun;
	NODE_ENV: "production";
	WEB_APP_URL: "https://nekoanimes-staging.pages.dev";
	ANDROID_LATEST_VERSION_CODE: "10036";
	ANDROID_LATEST_VERSION_NAME: "1.0.36";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "WEB_APP_URL" | "ANDROID_LATEST_VERSION_CODE" | "ANDROID_LATEST_VERSION_NAME">> {}
}
